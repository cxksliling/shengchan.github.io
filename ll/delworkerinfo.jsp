...
<body>
	...
	<div id="fh5co-page">
		...
		<div id="fh5co-main">
			...
			<tbody>
				<tr>
					...
					<td>${worker.workStatus}</td>
					<td>${worker.workProgress}</td>
					<td>${worker.workBeltline}</td>
					<td>${worker.workStation}</td>
				</tr>
			</tbody>
		...
		<%
			TWorkerInfo worker = (TWorkerInfo) request.getAttribute("worker");
			String workerId = worker.getWorkerId();
			String url = "window.location.href='./findworker_Del.action?workerId=";
			url += workerId;
			url += "'";
		%>
