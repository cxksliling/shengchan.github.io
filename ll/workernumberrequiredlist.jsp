...
<%@ page import="wwj.dao.TWorkersNumberRequired"%>
		...
		<div id="fh5co-main">
			...
			<div class="fh5co-narrow-content animate-box fh5co-border-bottom"
				...
				<div class="row">
					<div class="col-md-12">
						<table class="table table-hover">
							...
							<tbody>
								<%
									List workersNumberRequiredList = (List) request
											.getAttribute("workersNumberRequiredList");
									int listsize = workersNumberRequiredList.size();
									int i = 0;
									while (i < listsize) {
								%>
								<tr>
									<td><%=((TWorkersNumberRequired) workersNumberRequiredList
						.get(i)).getTypeOfWork()%></td>
									<td><%=((TWorkersNumberRequired) workersNumberRequiredList
						.get(i)).getAmount()%></td>

								</tr>
								<%
									request.setAttribute("needchegong",
												((TWorkersNumberRequired) workersNumberRequiredList
														.get(0)).getAmount());
										request.setAttribute("needqiangong",
												((TWorkersNumberRequired) workersNumberRequiredList
														.get(1)).getAmount());
										i++;
									}
				...
				<div class="row">
					...
					<input type="button" value="分配" class="btn btn-primary col-md-6"
						onclick="window.location.href='./assignworker.action'"
