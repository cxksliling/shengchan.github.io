...
<body>
<%
		TWorkerInfo worker = (TWorkerInfo) request
				.getAttribute("worker");
	%>
						...
						<form id="workerinfoform" method="post" class="form-horizontal"
							...
							<div class="form-group">
								...
								<div class="col-lg-5">
									<input type="text" class="form-control" name="workerId"
										value="${worker.workerId}" readonly />
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-lg-5">
									...
									<%
										if (worker.getTypeOfWork().trim().equals("车工")) {
									%>
									...
									<option value="钳工" selected="selected">钳工</option>
									<%
										}
									%>
							...
							<div class="form-group">
								...
								<div class="col-lg-5">
									...
									<%
										if (worker.getWorkStatus().trim().equals("闲")) {
									%>
									<option value="闲" selected="selected">闲</option>
									<option value="忙">忙</option>
									<%
										} else {
									%>
									<option value="闲" >闲</option>
									<option value="忙" selected="selected">忙</option>
									<%
										}
									%>
