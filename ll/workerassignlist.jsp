<%@page import="ll.model.TAssignInfo"%>
...
<body>
	...
	<div id="fh5co-page">
		...
		<tbody>
			<%
				List workers = (List) request.getAttribute("newAssignInfoList");
				int listsize = workers.size();
				int i = 0;
				while (i < listsize) {
			%>
			<tr>
				<td><%=((TAssignInfo) workers.get(i)).getWorkerId()%></td>
				<td><%=((TAssignInfo) workers.get(i)).getTypeOfWork()%></td>
			</tr>
			<%
				i++;
				}
