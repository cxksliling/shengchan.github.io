...
<%
TDamagedMaterialInfo eq = (TDamagedMaterialInfo) request.getAttribute("material");
    String wlkBh = eq.getWlkBh();
    String url = "window.location.href='./finddamage_Del.action?wlkBh=";
    url+=wlkBh;
    url+="'";
 %>
