...
<%@ page import="gsq.model.SemiFinishedGoodsInfo"%>
...
<body>
	...
	<div id="fh5co-page">
		...
		<form id="eqinfoform" method="post" class="form-horizontal"
			...
			<div class="form-group">
				<label class="col-lg-3 control-label">半成品类别</label>
				<div class="col-lg-5">
					<input type="text" class="form-control" name="wlkBcplb"
						value="${material.wlkBcplb}" />
				</div>
			</div>

			<div class="form-group">
				<label class="col-lg-3 control-label">半成品数量</label>
				<div class="col-lg-5">
					<input type="text" class="form-control" name="wlkBcpsl"
						value="${material.wlkBcpsl}" />
				</div>
			</div>

			<div class="form-group">
				<label class="col-lg-3 control-label">移交日期</label>
				<div class="col-lg-5">
					<input type="text" class="form-control" name="wlkYjrq"
						value="${material.wlkYjrq}" />
				</div>
			</div>
...
<div class="form-group">
				<label class="col-lg-3 control-label">生产线编号</label>
				<div class="col-lg-5">
					<input type="text" class="form-control" name="wlkScxbh"
						value="${material.wlkScxbh}" />
				</div>
			</div>
			
			<div class="form-group">
				<label class="col-lg-3 control-label">进出库状态</label>
				<div class="col-lg-5">
					<input type="text" class="form-control" name="wlkJckzt"
						value="${material.wlkJckzt}" />
				</div>
			</div>
			<div class="form-group">
