	...
	<table class="table table-hover">
		...
		<tbody>
			<%
				...
				int i = 0;
				while (i < listsize) {
					String url = "./findshenqing_Find.action?wlkBh=";
					url += ((TMateriaRequstInfo) eq.get(i)).getWlkBh();
					String url1 = "./findshenqing_DelInfo.action?wlkBh=";
					url1 += ((TMateriaRequstInfo) eq.get(i)).getWlkBh();
			%>
			<tr>
				<td><%=((TMateriaRequstInfo) eq.get(i)).getWlkBh()%></td>
				<td><%=((TMateriaRequstInfo) eq.get(i)).getWlkWllb()%></td>
				<td><%=((TMateriaRequstInfo) eq.get(i)).getWlkWlsl()%></td>
