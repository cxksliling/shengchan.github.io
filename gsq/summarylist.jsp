...
<%@ page import="gsq.model.TMaterialSummary"%>
<!DOCTYPE html>
	...
	<div id="fh5co-page">
		...
		<tbody>
			<%
				...
				int i = 0;
				while (i < listsize) {
					String url = "./findwuliaozongbiao_Find.action?wlkBh=";
					url += ((TMaterialSummary) eq.get(i)).getWlkBh();
					String url1 = "./findwuliaozongbiao_DelInfo.action?wlkBh=";
					url1 += ((TMaterialSummary) eq.get(i)).getWlkBh();
			%>
			<tr>
				<td><%=((TMaterialSummary) eq.get(i)).getWlkBh()%></td>
				<td><%=((TMaterialSummary) eq.get(i)).getWlkWllb()%></td>
				<td><%=((TMaterialSummary) eq.get(i)).getWlkWlsl()%></td>
				<td><%=((TMaterialSummary) eq.get(i)).getWlkTjrq()%></td>
				<td><%=((TMaterialSummary) eq.get(i)).getWlkCkbh()%></td>
