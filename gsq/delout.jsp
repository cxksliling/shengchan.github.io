	...
	<table class="table table-hover">
		...
		<tbody>
			<tr>
				...
				<td>${material.wlkWllb}</td>
				<td>${material.wlkWlsl}</td>
				<td>${material.wlkZcrq}</td>
				<td>${material.wlkCkbh}</td>
				<td>${material.wlkSqf}</td>
			</tr>
		</tbody>
...
<%
    TMaterialOutInfo eq = (TMaterialOutInfo) request.getAttribute("material");
    String wlkBh = eq.getWlkBh();
    String url = "window.location.href='./findout_Del.action?wlkBh=";
    url+=wlkBh;
    url+="'";
 %>
