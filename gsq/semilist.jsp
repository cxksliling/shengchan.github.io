	...
	<table class="table table-hover">
		...
		<tbody>
			<%
				...
				int i = 0;
				while (i < listsize) {
					String url = "./findsemi_Find.action?wlkBh=";
					url += ((SemiFinishedGoodsInfo) eq.get(i)).getWlkBh();
					String url1 = "./findsemi_DelInfo.action?wlkBh=";
					url1 += ((SemiFinishedGoodsInfo) eq.get(i)).getWlkBh();
			%>
			<tr>
				<td><%=((SemiFinishedGoodsInfo) eq.get(i)).getWlkBh()%></td>
				<td><%=((SemiFinishedGoodsInfo) eq.get(i)).getWlkBcplb()%></td>
				<td><%=((SemiFinishedGoodsInfo) eq.get(i)).getWlkBcpsl()%></td>
				<td><%=((SemiFinishedGoodsInfo) eq.get(i)).getWlkYjrq()%></td>
				<td><%=((SemiFinishedGoodsInfo) eq.get(i)).getWlkCkbh()%></td>
				<td><%=((SemiFinishedGoodsInfo) eq.get(i)).getWlkScxbh()%></td>
				<td><%=((SemiFinishedGoodsInfo) eq.get(i)).getWlkJckzt()%></td>
