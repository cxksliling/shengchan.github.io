...
<%@ page import="gsq.model.FinishedGoodsInfo"%>
...
<body>
	...
	<div id="fh5co-page">
		...
		<form id="eqinfoform" method="post" class="form-horizontal"
			...
			<div class="form-group">
				<label class="col-lg-3 control-label">成品类别</label>
				<div class="col-lg-5">
					<input type="text" class="form-control" name="wlkCplb"
						value="${material.wlkCplb}" />
				</div>
			</div>

			<div class="form-group">
				<label class="col-lg-3 control-label">成品数量</label>
				<div class="col-lg-5">
					<input type="text" class="form-control" name="wlkCpsl"
						value="${material.wlkCpsl}" />
				</div>
			</div>
