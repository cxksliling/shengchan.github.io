...
<body>
	...
	<div id="fh5co-page">
		...
		<form id="eqinfoform" method="post" class="form-horizontal"
			...
			<div class="form-group">
				<label class="col-lg-3 control-label">支出日期</label>
				<div class="col-lg-5">
					<input type="text" class="form-control" name="wlkZcrq"
						value="${material.wlkZcrq}" />
				</div>
			</div>
            ...
            <div class="form-group">
				<label class="col-lg-3 control-label">申请方</label>
				<div class="col-lg-5">
					<input type="text" class="form-control" name="wlkSqf"
						value="${material.wlkSqf}" />
				</div>
			</div>
			<div class="form-group">
