...
<%@ page import="gsq.model.TDamagedMaterialInfo"%>
	...
	<table class="table table-hover">
		...
		<tbody>
			<%
				...
				int i = 0;
				while (i < listsize) {
					String url = "./finddamage_Find.action?wlkBh=";
					url += ((TDamagedMaterialInfo) eq.get(i)).getWlkBh();
					String url1 = "./finddamage_DelInfo.action?wlkBh=";
					url1 += ((TDamagedMaterialInfo) eq.get(i)).getWlkBh();
			%>
			<tr>
				<td><%=((TDamagedMaterialInfo) eq.get(i)).getWlkBh()%></td>
				<td><%=((TDamagedMaterialInfo) eq.get(i)).getWlkWllb()%></td>
				<td><%=((TDamagedMaterialInfo) eq.get(i)).getWlkWlsl()%></td>
				<td><%=((TDamagedMaterialInfo) eq.get(i)).getWlkDjrq()%></td>
				<td><%=((TDamagedMaterialInfo) eq.get(i)).getWlkCkbh()%></td>
