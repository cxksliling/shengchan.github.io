...
<%
    TMaterialSummary eq = (TMaterialSummary) request.getAttribute("material");
    String wlkBh = eq.getWlkBh();
    String url = "window.location.href='./findwuliaozongbiao_Del.action?wlkBh=";
    url+=wlkBh;
    url+="'";
 %>
