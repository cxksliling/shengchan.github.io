...
<body>
	...
	<table class="table table-hover">
		...
		<tbody>
			<tr>
				<td>${material.wlkBh}</td>
				<td>${material.wlkBcplb}</td>
				<td>${material.wlkBcpsl}</td>
				<td>${material.wlkYjrq}</td>
				<td>${material.wlkCkbh}</td>
				<td>${material.wlkScxbh}</td>
				<td>${material.wlkJckzt}</td>
			</tr>
		</tbody>
...
<%
SemiFinishedGoodsInfo eq = (SemiFinishedGoodsInfo) request.getAttribute("material");
    String wlkBh = eq.getWlkBh();
    String url = "window.location.href='./findsemi_Del.action?wlkBh=";
    url+=wlkBh;
    url+="'";
 %>
