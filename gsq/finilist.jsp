...
<table class="table table-hover">
		...
		<tbody>
			<%
				...
				int i = 0;
				while (i < listsize) {
					String url = "./findfini_Find.action?wlkBh=";
					url += ((FinishedGoodsInfo) eq.get(i)).getWlkBh();
					String url1 = "./findfini_DelInfo.action?wlkBh=";
					url1 += ((FinishedGoodsInfo) eq.get(i)).getWlkBh();
			%>
			<tr>
				<td><%=((FinishedGoodsInfo) eq.get(i)).getWlkBh()%></td>
				<td><%=((FinishedGoodsInfo) eq.get(i)).getWlkCplb()%></td>
				<td><%=((FinishedGoodsInfo) eq.get(i)).getWlkCpsl()%></td>
				<td><%=((FinishedGoodsInfo) eq.get(i)).getWlkYjrq()%></td>
				<td><%=((FinishedGoodsInfo) eq.get(i)).getWlkCkbh()%></td>
				<td><%=((FinishedGoodsInfo) eq.get(i)).getWlkScxbh()%></td>
				<td><%=((FinishedGoodsInfo) eq.get(i)).getWlkJckzt()%></td>
