...
<%@ page import="gsq.model.TMaterialOutInfo"%>
	...
	<table class="table table-hover">
		...
		<tbody>
			<%
				...
				int i = 0;
				while (i < listsize) {
					String url = "./findout_Find.action?wlkBh=";
					url += ((TMaterialOutInfo) eq.get(i)).getWlkBh();
					String url1 = "./findout_DelInfo.action?wlkBh=";
					url1 += ((TMaterialOutInfo) eq.get(i)).getWlkBh();
			%>
			<tr>
				<td><%=((TMaterialOutInfo) eq.get(i)).getWlkBh()%></td>
				<td><%=((TMaterialOutInfo) eq.get(i)).getWlkWllb()%></td>
				<td><%=((TMaterialOutInfo) eq.get(i)).getWlkWlsl()%></td>
				<td><%=((TMaterialOutInfo) eq.get(i)).getWlkZcrq()%></td>
				<td><%=((TMaterialOutInfo) eq.get(i)).getWlkCkbh()%></td>
				<td><%=((TMaterialOutInfo) eq.get(i)).getWlkSqf()%></td>
