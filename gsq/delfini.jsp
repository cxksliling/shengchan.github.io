	...
	<table class="table table-hover">
		...
		<tbody>
			<tr>
				...
				<td>${material.wlkCplb}</td>
				<td>${material.wlkCpsl}</td>
...
<%
FinishedGoodsInfo eq = (FinishedGoodsInfo) request.getAttribute("material");
    String wlkBh = eq.getWlkBh();
    String url = "window.location.href='./findfini_Del.action?wlkBh=";
    url+=wlkBh;
    url+="'";
 %>
