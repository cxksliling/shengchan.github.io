		...
		<table class="table table-hover">
			...
			<tbody>
				<tr>
					...
					<td>${wuliaoma.jixieid}</td>
					<td>${wuliaoma.jixiexingneng}</td>
					<td>${wuliaoma.gongWeiId}</td>
				</tr>
			</tbody>
		</table>
		<hr>
	<%
			TWujiinfo eq = (TWujiinfo) request
					.getAttribute("wuliaoma");
			String wuliaoma = eq.getWuliaoma();
			String url = "window.location.href='./wuji_Del.action?wuliaoma=";
			url += wuliaoma;
			url += "'";
			{
		%>
