			...
			<div class="fh5co-narrow-content animate-box fh5co-border-bottom"
				...
				<div class="container">
					...
					<form id="eqinfoform" method="post" class="form-horizontal"
						action="findwork_Save.action">
						<!-- 下面这个div必须要有，插件根据这个进行添加提示 -->
						<div class="form-group">
							<label class="col-lg-3 control-label">设备编号</label>
							<div class="col-lg-5">
								<input type="text" class="form-control" name="equipmentId"
									value="${equipmentwork.equipmentId}"
									placeholder="Readonly input here…" readonly/>
							</div>
						</div>

						<div class="form-group">
							<label class="col-lg-3 control-label">设备位置</label>
							<div class="col-lg-5">
								<input type="text" class="form-control" name="equipmentLocation"
									value="${equipmentwork.equipmentLocation}" />
							</div>
						</div>

						<div class="form-group">
							<label class="col-lg-3 control-label">生产任务</label>
							<div class="col-lg-5">
								<input type="text" class="form-control" name="equipmentTask"
									value="${equipmentwork.equipmentTask}" />
							</div>
						</div>

						<div class="form-group">
							<label class="col-lg-3 control-label">设备是否正常</label>
							<div class="col-lg-5">
								<select class="form-control" name="equipmentIsNormal">
									<%
										if (eq.getEquipmentIsNormal().trim().equals("是")) {
									%>
						...
						<div class="form-group">
							<label class="col-lg-3 control-label">设备是否正在工作</label>
							<div class="col-lg-5">
								<select class="form-control" name="equipmentIsWorking">
									<%
										if (eq.getEquipmentIsWorking().trim().equals("是")) {
									%>
									<option value="是" selected="selected">是</option>
									<option value="否">否</option>
									<%
						...
						<div class="form-group">
							<div class="col-lg-9 col-lg-offset-3">
								...
								<input type="button" value="返回" class="btn btn-primary"
									onclick="window.location='http://localhost:8080//sc/zp/findwork_SearchAll.action'"></input>
							</div>
						</div>
					</form>
				</div>
