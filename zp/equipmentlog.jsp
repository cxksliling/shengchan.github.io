				...
				<div class="container">
					...
					<div id="navbar" class="navbar-collapse collapse">
						<ul class="nav navbar-nav navbar-right">
							...
							<li class="active"><a href="./findlog_SearchAll.action">设备日志</a>
							</li>
							<li><a href="./findwork_SearchAll.action">设备工作情况</a></li>
							<li><a href="./findequipment_SearchAll.action">设备信息</a></li>
							<li><a href="./equipmentnew.jsp">新增设备</a></li>
						</ul>
					</div>
					<!--/.nav-collapse -->
				</div>
						...
						<tbody>
							<%
								...
								while (i < listsize) {
									...
									url += i;
									String taskdate = ((TEquipmentLogInfo) eq.get(i)).getId()
											.getEquipmentTaskDate().substring(0,8);
							%>
							<tr>
			...
			<div class="fh5co-narrow-content">
				...
				<div class="row">
					<div class="col-md-12 animate-box" data-animate-effect="fadeInLeft">
						<p class="fh5co-lead">当设备工作状态发生变化时，系统将自动记录日志。</p>
						<p>
