						...
						<tbody>
							<%
								...
								while (i < listsize) {
									...
									url += ((TEquipmentWorkInfo) eq.get(i)).getEquipmentId();
							%>
							<tr>
								<td><%=((TEquipmentWorkInfo) eq.get(i)).getEquipmentId()%></td>
								<td><%=((TEquipmentWorkInfo) eq.get(i))
						.getEquipmentLocation()%></td>
								<td><%=((TEquipmentWorkInfo) eq.get(i)).getEquipmentTask()%></td>
								<td><%=((TEquipmentWorkInfo) eq.get(i))
						.getEquipmentIsNormal()%></td>
								<td><%=((TEquipmentWorkInfo) eq.get(i))
						.getEquipmentIsWorking()%></td>
								<td><a href=<%=url%>>修改 </a>
								</td>
							</tr>
							<%
								...
								request.removeAttribute("equipmentlist");
							%>
						</tbody>
					</table>
				</div>
			...
			<div class="fh5co-narrow-content">
				...
				<div class="row">
					<div class="col-md-12 animate-box" data-animate-effect="fadeInLeft">
						<p class="fh5co-lead">该表格记录了当前所有设备的动作信息，如果设备有异常，主页面也会显示。</p>
						<p>
