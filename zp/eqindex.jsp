...
<%@ page import="zp.model.TEquipmentWorkInfo"%>
<%
...
<body>
	...
	<div id="fh5co-page">
		...
		<div id="fh5co-main">
				...
				<div class="container">
					...
					<div id="navbar" class="navbar-collapse collapse">
						<ul class="nav navbar-nav navbar-right">
							<li class="active"><a href="/zp/summarywork.action">主页</a>
							</li>
							<li><a
			...
			<div class="col-md-4">
				<div class="header">
					<h4 class="title">设备工作情况</h4>
					<hr>
					<p class="category" align="right">工作:${isworking}</p>
					<p class="category" align="right" style="color:red">闲置:${notworking}</p>
				</div>
				<div class="content">
					...
					<h4 class="title">闲置设备</h4>
						...
						<div class="content">
							<table class="table">
								...
								<tbody>
									<%
										List eqwork = (List) request.getAttribute("equipmentlist");
										int listsize = eqwork.size(), i = 0;
										while (i < listsize) {
											if (((TEquipmentWorkInfo) (eqwork.get(i)))
													.getEquipmentIsWorking().trim().equals("否")) {
												String url = "./findwork_Find.action?equipmentId=";
												url += ((TEquipmentWorkInfo) eqwork.get(i))
														.getEquipmentId();
									%>
									<tr class="warning">
										<td><%=((TEquipmentWorkInfo) (eqwork.get(i)))
							.getEquipmentId()%></td>
										<td><%=((TEquipmentWorkInfo) (eqwork.get(i)))
							.getEquipmentLocation()%></td>
										<td><a href=<%=url%>>修改 </a></td>
									</tr>
									<%
										}
											i++;
							...
							<table class="table">
								...
								<tbody>
									<%
										...
										while (i < listsize) {
											if (((TEquipmentWorkInfo) (eqwork.get(i)))
													.getEquipmentIsNormal().trim().equals("否")) {
												String url1 = "./findwork_Find.action?equipmentId=";
												url1 += ((TEquipmentWorkInfo) eqwork.get(i))
														.getEquipmentId();
									%>
									<tr class="danger">
										<td><%=((TEquipmentWorkInfo) (eqwork.get(i)))
			...
			<div class="fh5co-narrow-content">
				<div class="row">
					<div class="col-md-4 animate-box" data-animate-effect="fadeInLeft">
						<h1 class="fh5co-heading-colored">系统功能</h1>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12 animate-box" data-animate-effect="fadeInLeft">
						<p class="fh5co-lead">设备管理系统主要提供对设备的管理方法，为其他部门提供设备数据。主页显示了当前时刻闲置与异常的设备。</p>
						<p>
	...
	<script type="text/javascript">
		...
		var myPie = new Chart(document.getElementById("canvas")
